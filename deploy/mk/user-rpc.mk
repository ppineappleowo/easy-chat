...
# 测试环境配置
# docker的镜像发布地址
DOCKER_REPO_TEST=crpi-sosoingx8l87enoq.cn-shanghai.personal.cr.aliyuncs.com/easy-chat/${SERVER_NAME}-${SERVER_TYPE}-dev
# 测试版本
VERSION_TEST=$(VERSION)
# 编译的程序名称
APP_NAME_TEST=sai-im-${SERVER_NAME}-${SERVER_TYPE}-test
